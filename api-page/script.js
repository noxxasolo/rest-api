document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        setContent('page', 'textContent', settings.name || "GLX8⚡NØXXΛꪶ𖣂ꫂ");
        setContent('wm', 'textContent', `© 2025 ${settings.apiSettings.creator}. All rights reserved.` || "© 2025 GLX8⚡NØXXΛꪶ𖣂ꫂ. All rights reserved.");
        setContent('header', 'textContent', settings.name || "GLX8⚡NØXXΛꪶ𖣂ꫂ");
        setContent('name', 'textContent', settings.name || "GLX8⚡NØXXΛꪶ𖣂ꫂ");
...
rainbowToggle.addEventListener('click', () => {
    ...
    if (rainbowActive) {
        ...
        rainbowToggle.classList.remove('btn-outline-dark');
        rainbowToggle.classList.add('btn-outline-light');
    } else {
        document.body.classList.remove('rainbow-bg');
        rainbowToggle.textContent = '🌈 ON';
        rainbowToggle.classList.remove('btn-outline-light');
        rainbowToggle.classList.add('btn-outline-dark');
    }
});
